...
public:
	...
	std::string inputFile = "C:\\Users\\Austin\\Desktop\\MIDIVisualization\\Visualization\\Projects\\BattleOfTheHeroes\\BattleOfTheHeroes";
	...
	*/
	...
	unsigned char colorArrayOffset = 0; //optional thing that 'rotates the colors around by 1 each (from 0-12) if you want to change the aestetics
	...
	//static std::mutex completed, execTime;
};
