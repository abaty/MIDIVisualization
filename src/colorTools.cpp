...
std::vector< unsigned char > decayRGBValue(unsigned char R, unsigned char G, unsigned char B, double elapsedFracNum, double elapsedFracDenom, double otherScaling , double initialL , double nTaus ) {
